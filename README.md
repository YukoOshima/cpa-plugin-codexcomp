...
[CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) 插件，检测并修复 gpt-5.5 流式 Responses API 请求中的推理截断以减少偶发的模型降智
...
插件通过 CPA 的 C ABI 插件系统拦截 gpt-5.5 流式 Responses API 请求并每当上游完成后，检查 reasoning_tokens 是否匹配 518n−2 模式。若匹配且存在 encrypted_content，则触发续写
